...
jQuery(function(t){t(document).on("click",'[data-toggle="offcanvas"]',function(){var a=t(t(this).attr("data-target"));a.toggleClass("active")})});
jQuery(function(s){s("html").removeClass("no-js").addClass("js")});
